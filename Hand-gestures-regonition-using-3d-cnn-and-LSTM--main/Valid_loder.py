...
csv_file = 'D:/3D-CNN/D/jester-v1-validation.csv' # training csv file
file = open(csv_file, 'r')
reader = csv.reader(file, delimiter=';')

path_dest2 = 'D:/3D-CNN/D/final_valid_set/'  # The folder where we will put all our training samples
...
path_dest10 = 'D:/3D-CNN/D/final_valid_set/'  # The folder where we will put all our training samples
...
path_dest12 = 'D:/3D-CNN/D/final_valid_set/'  # The folder where we will put all our training samples
...
path_dest5 = 'D:/3D-CNN/D/final_valid_set/'  # The folder where we will put all our training samples
...
%%time
path_dest6 = 'D:/3D-CNN/D/final_valid_set/'  # The folder where we will put all our training samples
